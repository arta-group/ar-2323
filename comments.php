...
<section class="pb-3 lg-pb-6 px-2 md-px-3 lg-px-0">
	...
	<div id="comments" class="comments-area mt-4/4 mb-5/8">
		...
		$fields = array(
			...
			'email'  => '<div class="comment-form-email"><label for="email">ایمیل</label><input type="hidden" id="email" name="email" value="' . esc_attr( $commenter[ 'comment_author_email' ] ) . '"></div>',
