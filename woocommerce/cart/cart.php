...
?>
<section class="flex flex-col lg-flex-row pt-3 pb-10 container mx-auto px-2 md-px-3 lg-px-0">
	<div class="w-full lg-w-auto lg-flex-1 mb-4">

		<form id="cart-form" class="woocommerce-cart-form border border-border rounded-xs overflow-hidden" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
							...
							<div class="flex lg-w-21 items-center justify-between">
								...
								<div class="product-remove">
									...
									echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
										...
										sprintf(
											'<a href="%s" class="remove flex items-center icon-close-alt text-primary-main text-2/4 leading-2/4 absolute lg-static top-4 left-2" aria-label="%s" data-product_id="%s" data-product_sku="%s"></a>',
			...
			<div class="actions"">
				...
				<button type="submit" form="cart-form" value="به روز رسانی" class="button hidden" name="update_cart"></button>
		...
		<div class="flex flex-row items-center justify-between mt-3/2">
			<button type="submit" form="cart-form" value="خالی کردن" name="clear-cart" class="flex btn-effect items-center px-1/5 md-px-3  py-0/8 md-py-1  bg-primary-main text-white rounded-xs">
