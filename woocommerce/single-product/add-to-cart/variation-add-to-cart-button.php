...
if ( $product->get_stock_status() == 'instock' ) {
    ...
    <div class="flex items-center mt-2 woocommerce-variation-add-to-cart variations_button">
        ...
        <button type="submit"
                class="single_add_to_cart_button w-full lg-w-auto py-1/1 px-2/8 rounded-xs bg-primary-main text-white text-lg leading-2/8 font-bold"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
