...
<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'woocommerce-table__line-item order_item', $item, $order ) ); ?>">
    ...
    <td class="woocommerce-table__product-name product-name" style="text-align: right;">
		<?php
        ...
        <div style="margin-top: 18px;">
            <a href="<?php echo $product_permalink ?>#reviews" target="_blank"
               style="background-color: #f6412d;padding: 8px 8px;border-radius: 8px;color: #ffffff;font-weight: bold;">
