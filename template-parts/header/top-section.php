    ...
    <div class="custom-hidden-m lg-flex items-center justify-between pt-4">
        ...
        <div class="flex flex-row items-center">
            ...
            <div class="flex flex-col mr-1/6">
                ...
                <a href="tel:<?php echo $phone; ?>"
                   class="flex flex-row-reverse items-center text-gray-main leading-3/3 text-2/1 font-bold dir-ltr ss02"><?php echo str_replace( '021', '021 - ', $phone ); ?></a>
            </div>
        </div>
        <!-- /contact info part -->
        ...
        <div class="flex items-end">
			...
			if ( function_exists( 'yith_wcwl_count_all_products' ) ) {
				?>
                <a href="<?php echo esc_url( site_url( '/my-account/wishlist/' ) ); ?>"
                   class="text-2/8 h-2/8 leading-2/8 text-gray-main relative icon-heart ml-2/1">
...
<?php } else { ?>
    ...
    <div class="flex lg-hidden items-center border-b border-border pt-1/7 pb-1/8 px-2 md-px-3 lg-px-0 justify-between">
        <button class="flex items-center text-base leading-1/4 h-1/4 icon-hamburger action--open"
                type="button"></button>
        <div id="mobile-header" class="c-header-mobile-menu">
            <nav id="ml-menu" class="menu">
                <div class="menu__wrap">
                    <div class="flex items-center justify-between mb-6">
                        <button class="flex items-center text-base leading-1/4 h-1/4 icon-times action--close"
                                type="button"></button>
                        <a href="<?php echo esc_url( site_url( '/' ) ) ?>" class="w-15 h-4">
                            <img class="object-fit object-center -mt-0/5"
                                 src="<?php echo get_stylesheet_directory_uri() . "/assets/img/svg/arta-logo.svg"; ?>"
                                 width="150" height="59" alt=""/>
                        </a>
                    </div>
                    <div>
						<?php
                        ...
                        <ul data-menu="main" class="menu__level" tabindex="-1" role="menu" aria-label="All">
                            ...
                            <li class="menu__item" role="menuitem">
                                <a class="menu__link off" id="amazing" href="<?php echo home_url( '/amazing' ); ?>">
                                    به‌صرفه خرید کنید </a>
                            </li>
							<?php
                    ...
                    <div class="absolute -mr-1 bottom-0 left-0 right-0 w-full flex items-center justify-between pb-3 px-4/5 dir-rtl">
                        ...
                        <a href="tel:<?php echo $phone; ?>" class="text-2/1 leading-3/3 text-gray-main font-bold"
                           dir="ltr"><?php echo str_replace( '021', '021 - ', $phone ); ?></a>
                    </div>
                </div>
            </nav>
        </div>
        ...
        <a href="<?php echo esc_url( site_url( '/' ) ) ?>" class="h-4 w-11 lg-w-19 lg-h-5">
            <img class="object-fit object-center"
                 src="<?php echo get_stylesheet_directory_uri() . "/assets/img/svg/arta-logo.svg"; ?>" width="110"
                 height="43" alt=""/>
        </a>
        ...
        <div class="flex items-end pl-1">
            ...
            <a href="<?php echo esc_url( site_url( '/my-account/wishlist/' ) ); ?>"
               class="h-1/9 text-1/9 leading-1/9 lg-text-2/8 lg-h-2/8 lg-leading-2/8 text-gray-main relative icon-heart ml-1/4 lg-ml-2/1">
            ...
            <a href="#"
               class="icon-cart h-1/9 text-1/9 leading-1/9 lg-h-3/2 lg-text-3/2 lg-leading-3/2 text-gray-main relative"
               id="cart">
